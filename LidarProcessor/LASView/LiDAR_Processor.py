...
class LASView:
    ...
    def __init__(self, iface):
        ...
        self.dlg = LASViewDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&LiDAR Processor')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'LASView')
        self.toolbar.setObjectName(u'LASView')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('LASView', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/LASView/icon.png'
        self.add_action(
            icon_path,
